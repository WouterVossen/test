...
if submit_spread:
    ...
    if sp_buy == sp_sell:
        ...
        st.error(f"Unknown months in spread: BUY '{_buy_raw}' / SELL '{_sell_raw}'.")
...
if password == "freightadmintrader":
    ...
    cm_default = "Oct" if "Oct" in MONTH_ORDER else MONTH_ORDER[0]
